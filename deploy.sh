...
# Запуск:
#   curl -fsSL https://raw.githubusercontent.com/AlexFimin/chess-undercover/master/deploy.sh | bash
...
# Firewall: добавляем правила на случай, если ufw активен (сам не включается)
